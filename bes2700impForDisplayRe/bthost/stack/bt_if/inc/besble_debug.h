...
#define DEBUG_GAP_DBG   1
#define DEBUG_GATT_DBG  1
#define DEBUG_ATT_DBG   1
#define DEBUG_L2C_DBG   1
#define DEBUG_SMP_DBG   1
#define DEBUG_APP_DBG   1
#define DEBUG_PRF_DBG   1
#define DEBUG_BLE_DBG   1
...
#define BLE_HCI_FUNC_ENTER()     TRACE(2, LOG_BLE_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_HCI_FUNC_LEAVE()     TRACE(2, LOG_BLE_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_GAP_FUNC_ENTER()     TRACE(2, LOG_GAP_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_GAP_FUNC_LEAVE()     TRACE(2, LOG_GAP_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_GATT_FUNC_ENTER()    TRACE(2, LOG_GATT_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_GATT_FUNC_LEAVE()    TRACE(2, LOG_GATT_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_ATT_FUNC_ENTER()     TRACE(2, LOG_ATT_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_ATT_FUNC_LEAVE()     TRACE(2, LOG_ATT_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_L2C_FUNC_ENTER()     TRACE(2, LOG_L2C_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_L2C_FUNC_LEAVE()     TRACE(2, LOG_L2C_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_SMP_FUNC_ENTER()     TRACE(2, LOG_SMP_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_SMP_FUNC_LEAVE()     TRACE(2, LOG_SMP_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_APP_FUNC_ENTER()     TRACE(2, LOG_APP_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_APP_FUNC_LEAVE()     TRACE(2, LOG_APP_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_PRF_HP_FUNC_ENTER()  TRACE(2, LOG_HTP_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_PRF_HP_FUNC_LEAVE()  TRACE(2, LOG_HTP_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)
#else
...
#define BLE_FUNC_ENTER()         TRACE(2, LOG_BLE_TAG"%s line: %d +++\n", __FUNCTION__, __LINE__)
#define BLE_FUNC_LEAVE()         TRACE(2, LOG_BLE_TAG"%s line: %d ---\n", __FUNCTION__, __LINE__)

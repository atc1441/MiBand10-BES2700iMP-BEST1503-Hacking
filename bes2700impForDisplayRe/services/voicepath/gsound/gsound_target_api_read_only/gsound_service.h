 ...
 * by the end user through the OEM Companion Application on the phone. The
 * device must be rebooted to connect Assistant again.
 *
 ...
 *
 * To support hotword, call GSoundServiceInitHotword[Internal/External]() after
 * the other two init calls. Hotword is disabled if GSoundServiceInitHotword* is
 * not called.
 *
 ...
 *
 * If used, these should be called after GSoundServiceInitAsTws or
 * GSoundServiceInitAsStereo
 */
